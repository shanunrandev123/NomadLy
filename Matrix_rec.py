...
# NJ_Nightlife_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/nightlife/NJ_Nightlife_Recommendation.pbz2")
# AB_Nightlife_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/nightlife/AB_Nightlife_Recommendation.pbz2")
# NV_Nightlife_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/nightlife/NV_Nightlife_Recommendation.pbz2")
# AZ_Nightlife_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/nightlife/AZ_Nightlife_Recommendation.pbz2")
...
# #
#
# NJ_Hotel_Recommendation = decompress_pickle('/home/ubuntu/capstone/Data/hotel/NJ_Hotel_Recommendation.pbz2')
# AB_Hotel_Recommendation = decompress_pickle('/home/ubuntu/capstone/Data/hotel/AB_Hotel_Recommendation.pbz2')
# NV_Hotel_Recommendation = decompress_pickle('/home/ubuntu/capstone/Data/hotel/NV_Hotel_Recommendation.pbz2')
# AZ_Hotel_Recommendation = decompress_pickle('/home/ubuntu/capstone/Data/hotel/AZ_Hotel_Recommendation.pbz2')
# # MO_Hotel_Recommendation = decompress_pickle('/home/ubuntu/capstone/Data/hotel/MO_Hotel_Recommendation.pbz2')


# NJ_Restaurent_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/restaurant/NJ_Restaurent_Recommendation.pbz2")
# AB_Restaurent_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/restaurant/AB_Restaurent_Recommendation.pbz2")
# NV_Restaurent_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/restaurant/NV_Restaurent_Recommendation.pbz2")
# AZ_Restaurent_Recommendation = decompress_pickle("/home/ubuntu/capstone/Data/restaurant/AZ_Restaurent_Recommendation.pbz2")
...
class MF_implicit:
    def __init__(self, train_mat, latent=5, lr=0.01, reg=0.01):
        ...
        self.Q = np.random.random(
            (self.num_movie, self.latent))  # latent factors for users, size (#movie, self.latent), randomly initialized
    ...
    def predict(self):
        ...
        for u in range(self.num_user):
            ...
            k = min(50, self.num_movie)
            top_k_iid = np.argpartition(scores, -k)[-k:]
            top_k_iid = top_k_iid[np.argsort(scores[top_k_iid])[-1::-1]]
            recommendation.append(top_k_iid)
...
#
# compressed_pickle("/home/ubuntu/capstone/Data/hotel/NJ_Hotel_MF", NJ_Hotel_MF)
#
#
# NJ_Restaurent_MF = calculateMF(NJ_Restaurent_Recommendation.ratings_mat)
#
# compressed_pickle("/home/ubuntu/capstone/Data/restaurant/NJ_Restaurent_MF", NJ_Restaurent_MF)
#
#
#
# NJ_Nightlife_MF = calculateMF(NJ_Nightlife_Recommendation.ratings_mat)
#
# compressed_pickle("/home/ubuntu/capstone/Data/nightlife/NJ_Nightlife_MF", NJ_Nightlife_MF)
#
#
#
#
