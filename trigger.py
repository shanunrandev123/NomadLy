...
if __name__ == '__main__':
    ...
    # rec_class_FL = hotel_state_rec_map['FL']
    ...
    rec_class = hotel_state_rec_map['LA']
    ...
    rec_class_res = restaurent_state_rec_map['FL']
    ...
    rec_class_NL = nightlife_state_rec_map['LA']
    ...
    recommended_indices = LA_Hotel_MF[user_id]

    for idx in recommended_indices:
        print('hotel recommendations using Matrix factorization')
        business_hash = rec_class.getBusinessHashFromBusinessNum(idx)
        business = rec_class.getBusinessInfo(business_hash)
        print(f"Name: {business.name}")
        print(f"Address: {business.address}, {business.city}, {business.state} {business.postal_code}")
    ...
    recommended_indices = LA_Nightlife_MF[user_id]

    for idx in recommended_indices:
        print('clubs/lounges recommendations using Matrix factorization for LA state')
        business_hash = rec_class_NL.getBusinessHashFromBusinessNum(idx)
        business = rec_class_NL.getBusinessInfo(business_hash)
        print(f"Name: {business.name}")
        print(f"Address: {business.address}, {business.city}, {business.state} {business.postal_code}")
        print(f"Stars: {business.stars}")
        print("-" * 40)
    ...
    aecf_model = LA_Hotel_AECF

    user_id = 5

    recommended_indices = aecf_model.get_user_recommendation(user_id)

    for idx in recommended_indices:
        print('LA hotel recommendation using AECF')
        business_hash = rec_class.getBusinessHashFromBusinessNum(idx)
        business = rec_class.getBusinessInfo(business_hash)
        print(f"Name: {business.name}")
        print(f"Address: {business.address}, {business.city}, {business.state} {business.postal_code}")
    ...
    aecf_model_res = FL_Restaurent_AECF

    user_id = 2
    recommended_indices = aecf_model_res.get_user_recommendation(user_id)

    for idx in recommended_indices:
        print('Florida restaurant recommendation using auto encoder Collaborative filtering')
        business_hash = rec_class_res.getBusinessHashFromBusinessNum(idx)
        business = rec_class_res.getBusinessInfo(business_hash)
        print(f"Name: {business.name}")
        print(f"Address: {business.address}, {business.city}, {business.state} {business.postal_code}")
        print(f"Stars: {business.stars}")
        print("-" * 40)
